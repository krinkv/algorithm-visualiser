...
public class GraphConfig {
    ...
    public static final List<TextLayoutDetails> UNINFORMED_SEARCH_GRAPH_TEXT_LABELS = List.of(
            new TextLayoutDetails(220d, 52d, "A", 17.414215087890625d),
            new TextLayoutDetails(117d, 113d, "B", 17.414215087890625d),
            new TextLayoutDetails(256d, 115d, "C", 17.414215087890625d),
            new TextLayoutDetails(405d, 115d, "D", 17.414215087890625d),
            new TextLayoutDetails(77d, 199d, "E", 17.414215087890625d),
            new TextLayoutDetails(157d, 199d, "F", 17.414215087890625d),
            new TextLayoutDetails(242d, 199d, "G", 17.414215087890625d),
            new TextLayoutDetails(323d, 199d, "H", 17.414215087890625d),
            new TextLayoutDetails(413d, 195d, "I", 17.414215087890625d),
            new TextLayoutDetails(84d, 288d, "J", 17.414215087890625d)
    );
    ...
    public static final List<TextLayoutDetails> MOUNTAIN_GRAPH_TEXT_LABELS_EDGES = List.of(
            new TextLayoutDetails(150d, 77d, "3", 17.414215087890625d),
            new TextLayoutDetails(67d, 46d, "3", 17.414215087890625d),
            new TextLayoutDetails(67d, 98d, "2", 17.414215087890625d),
            new TextLayoutDetails(59d, 196d, "4", 17.414215087890625d),
            new TextLayoutDetails(114d, 290d, "4", 17.414215087890625d),
            new TextLayoutDetails(221d, 295d, "3", 17.414215087890625d),
            new TextLayoutDetails(306d, 217d, "3", 17.414215087890625d),
            new TextLayoutDetails(377d, 188d, "2", 17.414215087890625d),
            new TextLayoutDetails(420d, 272d, "2", 17.414215087890625d),
            new TextLayoutDetails(232d, 98d, "2", 17.414215087890625d),
            new TextLayoutDetails(293d, 69d, "3", 17.414215087890625d),
            new TextLayoutDetails(329d, 98d, "3", 17.414215087890625d),
            new TextLayoutDetails(315d, 133d, "2", 17.414215087890625d)
            );
